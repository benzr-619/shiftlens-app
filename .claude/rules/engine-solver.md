...
| `solveEdHoldJointCoverage` | `edHoldSolve.ts` | Panel 5. Joint ED+hold full-coverage greedy fill, no trim phase. Hold candidates gated on remaining medical-boarding demand; `allowedHoldShifts` enforced structurally. |
