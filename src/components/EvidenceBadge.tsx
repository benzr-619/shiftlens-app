export type EvidenceStatus = 'ESTABLISHED' | 'CONSENSUS' | 'CONVENTION' | 'ASSUMPTION' | 'USER INPUT';
...
const STYLE: Record<EvidenceStatus, { bg: string; fg: string }> = {
  ...
  'USER INPUT': { bg: '#2a2a3d', fg: '#c5b8f0' },
};
...
const TOOLTIP: Record<EvidenceStatus, string> = {
  ...
  'USER INPUT': 'ED-specific data or policy choice; never hardcoded.',
};
